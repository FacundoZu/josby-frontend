  ...
  return (
    <section className="w-full bg-linear-to-r from-primary-dark/90 to-primary py-20 px-6">
      <div className="max-w-4xl mx-auto text-center text-white">
        ...
        <div className="mt-8 flex flex-col md:flex-row items-center justify-center w-full max-w-2xl mx-auto">
          ...
          <div className="flex bg-white p-3 shadow-lg w-full rounded-xl md:rounded-l-xl md:rounded-r-none">
            ...
            <input type="text" placeholder="Buscar por servicio o profesional" className="flex-1 outline-none px-2 text-text-secondary-dark" />
          </div>

          <button className="bg-primary-dark hover:bg-primary-dark/80 text-white font-semibold shadow-lg px-6 py-3 mt-3 md:mt-0 w-full md:w-auto rounded-xl md:rounded-r-xl md:rounded-l-none cursor-pointer">
            Buscar
          </button>
