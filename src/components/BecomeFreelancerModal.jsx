        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm transition-opacity" onClick={onClose}>
            ...
            >
                ...
                <div className="flex justify-end gap-3 mt-6">
                    ...
                    <button
                        onClick={onConfirm}
                        className="px-6 py-2 text-sm font-medium text-white bg-[#38ced6] hover:bg-[#2aa8b0] rounded-lg shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-cyan-500"
                    >
                        Confirmar
                    </button>
                </div>
